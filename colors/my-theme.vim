...
call s:Hi("LineNr", "guifg=" . s:colors.base3 . " guibg=" . s:colors.base1)
...
call s:Hi("Folded", "guifg=" . s:colors.base6 . " guibg=" . s:colors.blue)
...
call s:Hi("PmentSel", "guifg=" . s:colors.base7 . " guibg=" . s:colors.base4)
...
call s:Hi("ModeMsg", "guifg=" . s:colors.blue)
call s:Hi("StatusLine", "guifg=" . s:colors.base5 . " guibg=" . s:colors.base3)
call s:Hi("WildMenu", "guifg=" . s:colors.base7 . " guibg=" . s:colors.cyan)
...
call s:Hi("SpellBad", "guifg=" . s:colors.base7 . " guibg=" . s:colors.red)
call s:Hi("SpellCap", "guifg=" . s:colors.base7 . " guibg=" . s:colors.blue)
...
call s:Hi("jsTemplateVar", "guifg=" . s:colors.dark_green . " gui=bold,italic")
